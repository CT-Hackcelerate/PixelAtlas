...
allowed-tools: mcp__pixel-atlas__find_recipe, mcp__pixel-atlas__resolve_seed, mcp__pixel-atlas__get_iod_requirements, mcp__pixel-atlas__describe_attributes, mcp__pixel-atlas__extract_spec, mcp__pixel-atlas__validate_spec, mcp__pixel-atlas__materialize_dataset, mcp__pixel-atlas__validate_dataset, mcp__pixel-atlas__store_to_pacs
argument-hint: modality=<CT|MR|US|...> count=<n> [body_part=] [orientation=] [enhanced=true] [tag=value ...]
---
